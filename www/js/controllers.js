...
.controller('HomeCtrl', function($scope, $timeout, ionicDatePicker, $ionicPopup) {
	...
	$scope.showPopupKind = function() {
	  var popup = $ionicPopup.show({
		templateUrl: 'templates/home/kind.tpl',
...
.controller('AreaCtrl', function($scope, $http, $ionicModal){
	...
	$ionicModal.fromTemplateUrl('templates/sign/areacode.tpl', {
    scope: $scope,
...
.controller('BookingCtrl', function($scope, $http, $state, $ionicModal){
	...
	$ionicModal.fromTemplateUrl('templates/booking/select-time.tpl', {
    scope: $scope,
	animation: 'slide-in-up'
	}).then(function(modal) {
	...
	$ionicModal.fromTemplateUrl('templates/booking/cancel.tpl', {
    scope: $scope,
	animation: 'slide-in-up'
	}).then(function(modal) {
	...
	$ionicModal.fromTemplateUrl('templates/booking/payment.tpl', {
    scope: $scope,
	animation: 'slide-in-up'
	}).then(function(modal) {
	...
	$ionicModal.fromTemplateUrl('templates/booking/select-bank.tpl', {
    scope: $scope,
	animation: 'slide-in-up'
	}).then(function(modal) {
...
.controller('searchCtrl', function($scope, $http, $ionicModal){
	...
	$ionicModal.fromTemplateUrl('templates/search/sort.tpl', {
    scope: $scope,
	animation: 'slide-in-up'
	}).then(function(modal) {
...
.controller('detailCtrl', function($scope, $http, $ionicPopup, IonicClosePopupService, $timeout, $state){
	...
	var popup = $ionicPopup.show({
	templateUrl: 'templates/detail/primary-guest.tpl',
